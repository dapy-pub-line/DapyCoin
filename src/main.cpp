...
int64 nChainStartTime = 1531361050;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "DpayCoin is a good coins";
        CTransaction txNew;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0xadc04630f219986341e0b03363e7a9dffad92d4e923963ca88fae98710375314"));
